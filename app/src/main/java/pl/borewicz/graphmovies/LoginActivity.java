...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(server)) {
            mUserView.setError(getString(R.string.error_invalid_server));
        ...
        if (cancel) {
            ...
            showProgress(true);
            mAuthTask = new UserLoginTask(server, user, password);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        UserLoginTask(String uri, String email, String password) {
            mUri = uri;
            mEmail = email;
            mPassword = password;
        }
